...
class LlamaForMLPRegression(LlamaForCausalLM):
    ...
    def get_last_token_hidden_state(
        ...
        labels (`torch.LongTensor` of shape `(batch_size,)`, *optional*):
            ...
            configs.num_labels - 1]`. If `configs.num_labels == 1` a regression loss is computed (Mean-Square loss), If
            `configs.num_labels > 1` a classification loss is computed (Cross-Entropy).
        """
